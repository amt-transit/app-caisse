...
export const HistoryView = {
        ...
        container.innerHTML = `
            <div class="dashboard-container">
                <div class="history-controls" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 10px;">
                    <h2 style="margin: 0; color: #1e293b;">📋 Historique des Opérations</h2>
                    <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                        <input type="date" id="startDate" class="search-filter">
                        <input type="date" id="endDate" class="search-filter">
                        <input type="text" id="smartSearch" placeholder="Rechercher (Réf, Nom, etc.)..." class="search-filter" style="min-width: 250px;">
                        <select id="agentFilter" class="search-filter"><option value="">Tous les agents</option></select>
                        <div style="display: flex; align-items: center; gap: 5px;">
                            <input type="checkbox" id="showDeletedCheckbox" style="width: auto; margin: 0;">
                            <label for="showDeletedCheckbox" style="margin: 0; cursor: pointer; font-size: 13px;">Afficher supprimés</label>
                        </div>
                    </div>
                </div>
            ...
            <div id="paymentHistoryModal" class="modal"><div class="modal-content" style="max-width: 500px; border-radius: 12px;"><span class="close-modal" style="float: right; cursor: pointer; font-size: 24px;">&times;</span><h2 id="modalRefTitle" style="margin-top: 0; color: #1e293b;">Détails</h2><hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 15px 0;"><ul id="paymentHistoryList" style="list-style-type: none; padding: 0; margin: 0;"></ul></div></div>
        `;
    ...
    initLogic() {
        ...
        showDeletedCheckbox.addEventListener('change', () => fetchHistory(false));
        ...
        function insertDataRow(data, returnElement = false) {
            ...
            const textToClassName = (t) => t ? t.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/\s+/g, '-') : '';
